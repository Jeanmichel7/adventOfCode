...
solvD3();
*/
var dataD3 = require("./data.json");
// const dataD3 = require("./dataDemo.json");
var includeSymbole = function (c) {
    // if (c == undefined) return false;
    // // const symb = "*#+-$/=<>@^&|?_!";
    // return symbole.includes(c);
    if (c == undefined)
...
var extractWord = function (dataD3, y, x) {
    var word = "";
    // let initIndex = x;
...
var charIsAdj = function (dataD3, y, x) {
    var tab = [];
    if (y - 1 >= 0) {
    ...
    // console.log("tab : ", tab);
    var resultTab = tab.filter(function (e, i, tab) { return tab.indexOf(e) === i; });
...
var solvD3 = function () {
    ...
    for (var i = 0; i < dataD3.length; i++) {
        for (var j = 0; j < dataD3[i].length; j++) {
            var c = dataD3[i][j];
            if (c == "*") {
                var test = 0;
